...
var host = "34.83.195.31";    //from GCloud instance (change to match your db)
var database = "CHEESECAKE";  //database name
var user = "root";         //username (change to match your db)
// I Know this is a Sh*ty password 
var password = "Stelio9.";  //password (change to match your db, yes this is very poor practice)
